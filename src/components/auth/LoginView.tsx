...
import { loginWithEmailPassword, signInWithGoogle, signInAnonymouslyUser } from '../../services/firebaseService';
import { Lock, Mail, ArrowRight, Loader2, ShieldCheck, Zap } from 'lucide-react';
